...
# ## Tasks
# %% [markdown]
# We deal with MEG Data ! [to do exploration]
# %% [markdown]
# Tasks:
#
#
...
# /storage/store/data/camcan/camcan47/cc700/meg/pipeline/release004/data_info/trigger_codes.txt. Set manually adequate reject parameter in Epochs or use autoreject local to clean the data from remaining artifacts.
#
#
...
# here /storage/store/data/camcan-mne/trans/ and MRIs can be found in /storage/store/data/camcan-mne/freesurfer/. Plot transformations to compare the results.
#
#
# Compute the dSPM inverse solution on the cortical surface
# for both covariance matrices. You will need to make a forward solution first (you can create a forward solution after setting up a source space, making a bem model and bem solution).
